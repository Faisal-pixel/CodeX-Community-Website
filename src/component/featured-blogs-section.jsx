...
const FeaturedBlogs = () => {
    return <>
        <div className="container mx-auto bg-primaryWhite flex flex-col space-y-20 px-[15%] py-[3rem] lg:px-[7%]">
            <h2 className="font-bold text-4xl text-center">Featured Blogs</h2>
            <div className="flex flex-row lg:space-x-5 lg:space-y-0 space-y-4 flex-wrap">
